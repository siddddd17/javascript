...
rect.addEventListener('mousemove', function(event){
    ...
    if(cursorLocation<(rectLocation.width/2)){
        let redColor=gsap.utils.mapRange(0,rectLocation.width/2,250,0,cursorLocation);
        gsap.to(rect,{
    ...
    if(cursorLocation>(rectLocation.width/2)){
        let blueColor=gsap.utils.mapRange(rectLocation.width/2,rectLocation.width,0,250,cursorLocation);
        gsap.to(rect,{
